...
sys.path.insert(0, str(TEST_CF / "core")); sys.path.insert(0, str(TEST_CF / "RL-real"))
...
def main():
    ...
    out = TEST_CF / "data" / "thrust_calib.npz"
    np.savez(out, pwms=pwms, forces=forces, coef=[a, b, c], genesis_mass=genesis_mass)
